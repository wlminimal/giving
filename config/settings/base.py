...
ADMINS = [
    ("""Taehwan Kim""", 'taedori@outlook.com'),
]
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres:///giving'),
}
...
ACCOUNT_ADAPTER = 'giving.users.adapters.AccountAdapter'
SOCIALACCOUNT_ADAPTER = 'giving.users.adapters.SocialAccountAdapter'
